...
@section('addfeaturedblog')
<!-- Add Post Form -->
<div id="add-post" class="p-6 pt-0 bg-white shadow-md rounded-lg">
    <h3 class="text-3xl font-bold text-blue-800 mb-3">Add Featured Post</h3>

    <form action="{{ route('featured_blogs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
        @csrf

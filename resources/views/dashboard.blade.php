      ...
      <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="lg:w-1/2 bg-gray-200 flex flex-col rounded-lg">
          ...
          <div class="p-4 flex flex-col flex-1">
            <h2 class="text-[40px] font-extrabold mb-2 tracking-widen leading-10">Are You Looking for the Best Deals On Removal Quotes Online?</h2>
            <p class="text-gray-600 mb-2">By <span class="font-semibold">Author Name</span> | Posted on <span class="font-semibold">Posted Time</span></p>
            <p class="text-gray-700 flex-1 text-[18px] ">This is a detailed description of the blog post. It should be a concise summary, about 50 words long, providing an overview of the content to entice readers to learn more.</p>
        ...
        <div class="lg:w-1/2 flex flex-col gap-4">
          <div class="flex gap-4">
            ...
            <div class="bg-gray-200 flex flex-col flex-1 rounded-lg">
              <img src="assest/images/featured2.jpg" alt="Blog Image" class="w-full h-40  object-cover rounded-t-lg">
              <div class="p-4 flex flex-col flex-1">
                <h2 class="text-[25px] font-semibold mb-1">Blog Heading</h2>
                <p class="text-gray-700 flex-1 text-[20px] leading-6">This is a brief description of the blog post.</p>
                <a href="#" class="text-blue-500 hover:underline mt-2">Learn More</a>
              </div>
            </div>
  
            <div class="bg-gray-200 flex flex-col flex-1 rounded-lg"> 
              <img src="assest/images/featured3.jpg" alt="Blog Image" class="w-full h-40 object-cover rounded-t-lg">
              <div class="p-4 flex flex-col flex-1">
                <h2 class="text-[25px] font-semibold mb-1">Blog Heading</h2>
                <p class="text-gray-700 flex-1 text-[20px] leading-6">This is a brief description of the blog post.</p>
                <a href="#" class="text-blue-500 hover:underline mt-2">Learn More</a>
          ...
          <div class="flex gap-4">
            <!-- Second Row -->
            <div class="bg-gray-200 flex flex-col flex-1 rounded-lg">
              <img src="assest/images/featured4.jpg" alt="Blog Image" class="w-full  h-40  object-cover rounded-t-lg">
              <div class="p-4 flex flex-col flex-1">
                <h2 class="text-[25px] font-semibold mb-1">Blog Heading</h2>
                <p class="text-gray-700 flex-1 text-[20px] leading-6">This is a brief description of the blog post.</p>
                <a href="#" class="text-blue-500 hover:underline mt-2">Learn More</a>
            ...
            <div class="bg-gray-200 flex flex-col flex-1 rounded-lg">
              <img src="assest/images/featured5.jpg" alt="Blog Image" class="w-full h-40  object-cover rounded-t-lg">
              <div class="p-4 flex flex-col flex-1">
                <h2 class="text-[25px] font-semibold mb-1">Blog Heading</h2>
                <p class="text-gray-700 flex-1 text-[20px] leading-6">This is a brief description of the blog post. </p>
                <a href="#" class="text-blue-500 hover:underline mt-2">Learn More</a>
    ...
    <div class="container m-auto px-4" >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-7">
            ...
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image1.jpg" alt="Blog Image 1" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 1</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-01">September 1, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
            </div>
            <!-- Blog Item 2 -->
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image2.jpg" alt="Blog Image 2" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 2</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-02">September 2, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
            ...
            <!-- Blog Item 3 -->
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image3.jpg" alt="Blog Image 3" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 3</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-03">September 3, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
            ...
            <!-- Blog Item 4 -->
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image4.jpg" alt="Blog Image 4" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 4</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-04">September 4, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
            ...
            <!-- Blog Item 5 -->
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image5.jpg" alt="Blog Image 5" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 5</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-05">September 5, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
            ...
            <!-- Blog Item 6 -->
            <div class=" p-4 rounded-lg shadow-lg bg-blue-50">
                <img src="assest/images/path-to-image6.jpg" alt="Blog Image 6" class="w-full h-52 object-cover rounded-t-lg mb-4">
                <h3 class="text-xl font-semibold mb-2">Blog Heading 6</h3>
                <p class="text-sm text-gray-500 mb-2">By Author Name | <time datetime="2024-09-06">September 6, 2024</time></p>
                <p class="text-gray-700 text-sm mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod nisi non lorem imperdiet, id convallis mauris convallis. Integer vel urna non velit ullamcorper cursus. Nullam consectetur facilisis nunc.
                </p>
                <a href="#" class="text-blue-500 hover:underline">Learn More</a>
...
<section class="bg-gray-100 py-6">
    <div class="container mx-auto px-4">
        ...
        <div class="slick-slider">
            <!-- Item 1 -->
            <div class="m-3">
                <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-1.html'">
                    <img src="assest/images/explore1.jpg" alt="Blog Image 1" class="w-full h-48 object-cover rounded-t-lg mb-4">
                    <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 1</span> | Posted on <span class="font-semibold">Date 1</span></p>
            ...
            <!-- Item 2 -->
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-2.html'">
                <img src="assest/images/explore2.jpg" alt="Blog Image 2" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 2</span> | Posted on <span class="font-semibold">Date 2</span></p>
            ...
            <!-- Item 3 -->
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-3.html'">
                <img src="assest/images/explore3.jpg" alt="Blog Image 3" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 3</span> | Posted on <span class="font-semibold">Date 3</span></p>
            ...
            <!-- Item 4 -->
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore4.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore5.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore6.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore7.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore8.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore9.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
            ...
            <div class="m-3">
            <div class="p-4 bg-white rounded-lg shadow cursor-pointer" onclick="window.location.href='link-to-page-4.html'">
                <img src="assest/images/explore10.jpg" alt="Blog Image 4" class="w-full h-48 object-cover rounded-t-lg mb-4">
                <p class="text-gray-500 text-sm mt-2">By <span class="font-semibold">Author 4</span> | Posted on <span class="font-semibold">Date 4</span></p>
        ...
        <div class="slick-slider gap-3">
          ...
          <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 1" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 2" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 3" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <!-- Review Item 4 --> <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 4" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 5" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 6" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 7" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 8" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
                <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                    <img src="assest/images/review2.jpg" alt="Customer 9" class="w-24 h-24 rounded-full mx-auto mb-4">
            ...
            <div class="m-3">
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                <img src="assest/images/review2.jpg" alt="Customer 10" class="w-24 h-24 rounded-full mx-auto mb-4">
